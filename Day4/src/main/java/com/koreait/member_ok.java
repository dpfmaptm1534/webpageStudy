...
public class member_ok extends HttpServlet {
	...
	/* 			System.out.println("DB연결 성공!"); */
		...
		writer.println("<html><head><meta charset=\"UTF-8\"><title>회원가입 완료</title></head><body><h2>회원가입 완료</h2><p>"+name+"("+userid+")님 회원가입이 완료되었습니다</p><p><a href='./a_login.jsp'>로그인하러가기</a></p></body></html>");
